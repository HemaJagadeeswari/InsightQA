...
public class HomePage extends TestBase{
	...
	public void HomePageImageVerification() throws IOException, AWTException
	{
		...
		BufferedImage expectedImage = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\HomePage1.png"));
		...
		ImageIO.write(ImageScreenshot.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\HomePage1.png"));
		...
		BufferedImage expectedImage1 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\HomePage2.png"));
	...
	Screenshot ImageScreenshot1= new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(Driver);
		...
		ImageIO.write(ImageScreenshot1.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\HomePage2.png"));
		...
		WebElement l=Driver.findElement(By.xpath("//*[contains(text(),'Prev. Wage Project -')]"));
	      ...
	      //Thread.sleep(800);
	      BufferedImage expectedImage2 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\HomePage3.png"));
		//Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		...
		ImageIO.write(ImageScreenshot2.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\HomePage3.png"));
	...
	public void Employeesview() throws IOException, AWTException
	{
	    ...
	    CrossProjectEmployees.click();
	      //Thread.sleep(800);
	    BufferedImage expectedImage = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\CrossProjectEmployees.png"));
		Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		Screenshot ImageScreenshot= new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(Driver);

		Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		ImageIO.write(ImageScreenshot.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\CrossProjectEmployees.png"));
	    ...
	    BufferedImage expectedImage1 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\EmployeeDetails.png"));
		EmployeeDetails.click();
		Screenshot ImageScreenshot1= new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(Driver);

		Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		ImageIO.write(ImageScreenshot1.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\EmployeeDetails.png"));
	...
	public void Contractorsview() throws IOException, AWTException
	{
		...
		Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		ImageIO.write(ImageScreenshot.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\CrossProjectContractors.png"));
		...
		BufferedImage expectedImage1 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\ContractorDetails.png"));
		ContractorDetails.click();
		Screenshot ImageScreenshot1= new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(Driver);

		Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		ImageIO.write(ImageScreenshot1.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\ContractorDetails.png"));
	...
	public void SearchByContractorviewImageVerification() throws IOException, AWTException
	{
	    ...
	    BufferedImage expectedImage = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SearchContractor1.png"));
		...
		ImageIO.write(SearchContractor1.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SearchContractor1.png"));
		...
		BufferedImage expectedImage1 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SearchContractor2.png"));
		...
		ImageIO.write(SearchContractor2.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SearchContractor2.png"));
	...
	public void SearchByContractorviewSearch() throws IOException, AWTException
	{
	    ...
	    Search.sendKeys("123");
	    Searchbutton.click();
	    BufferedImage expectedImage = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SearchByContractorviewSearch1.png"));
		...
		ImageIO.write(ImageScreenshotS.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SearchByContractorviewSearch1.png"));
		...
		ImageDiffer Diff = new ImageDiffer();
		   ImageDiff Dif= Diff.makeDiff(expectedImage, actualImage1);
			...
			BufferedImage expectedImage1 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SearchByContractorviewSearch2.png"));
		...
		Driver.manage().timeouts().implicitlyWait(TestUtil.Implicit_Time,TimeUnit.SECONDS);
		ImageIO.write(SearchContractor2.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SearchByContractorviewSearch2.png"));
		...
		ImageDiffer Diff1 = new ImageDiffer();
		   ImageDiff Dif1= Diff1.makeDiff(expectedImage1, actualImage);
			...
			Arrowbutton.click();
		   BufferedImage SearchSub = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SearchByContractorviewSub1.png"));
		    Driver.manage().timeouts().implicitlyWait(50,TimeUnit.SECONDS);
		    ((JavascriptExecutor) Driver).executeScript("window.scrollBy(0,40000)");
			...
			ImageIO.write(SearchSub1.getImage(), "png",
					new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SearchByContractorviewSub1.png"));
			...
			ImageDiffer Diff2 = new ImageDiffer();
			   ImageDiff Dif2= Diff2.makeDiff(SearchSub, actualImage2);
				...
				BufferedImage SearchSub3 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SearchByContractorViewSub2.png"));
			...
			ImageIO.write(SearchSub4.getImage(), "png",
					new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SearchByContractorviewSub2.png"));
	...
	public void SingleContractorsImageVerification() throws IOException, AWTException
	{
	   ...
	   BufferedImage expectedImage = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SingleContractor1.png"));
		...
		ImageIO.write(SingleContractor.getImage(), "png",
				new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SingleContractor1.png"));
		...
		BufferedImage expectedImage1 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SingleContractor2.png"));
			...
			ImageIO.write(SingleContractor1.getImage(), "png",
					new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SingleContractor2.png"));
		...
		BufferedImage expectedImage2 = ImageIO.read(new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\Baseline\\SingleContractor3.png"));
		WebElement P=Driver.findElement(By.xpath("//*[contains(text(),'Prev. Wage Project -')]"));
	      ...
	      Screenshot SingleContractor2= new AShot().shootingStrategy(ShootingStrategies.viewportPasting(1000)).takeScreenshot(Driver);
			...
			ImageIO.write(SingleContractor2.getImage(), "png",
					new File("F:\\SkillSmart\\SkillSmart Automation\\Workspace\\Insight\\UI Image\\SingleContractor3.png"));
